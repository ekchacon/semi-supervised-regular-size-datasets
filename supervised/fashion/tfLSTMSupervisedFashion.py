...
for j in range(17,20):
  ...
  for i in range(0,10,1):
    ...
    results = model.evaluate(x=test, verbose=1, steps=19) 
    if i == 0:
  ...
  f = open('/home/est1/Edgar/Semestre 3/model implementation/realExperiments/supervised/supervisedFashion.csv','a')
